...
# --- CSS Data ---
# Using simpler Hex codes and resetting background-image
CSS_DATA = b"""
#button-copy {
    background-image: none; /* Remove theme gradients */
    background-color: #FFB6C1; /* LightPink */
    border: 1px solid #A0A0A0; /* Slightly darker border */
    color: #000000; /* Ensure text is visible */
}
#button-copy:hover {
    background-color: #FFA0B1; /* Slightly darker pink */
}
#button-pin {
    background-image: none; /* Remove theme gradients */
...
#button-pin:hover {
    background-color: #FFFFAA; /* Slightly darker yellow */
}
#button-clear {
    background-image: none; /* Remove theme gradients */
...
#button-clear:hover {
    background-color: #9ACEEB; /* Slightly darker blue */
}
"""
...
def copy_text_to_clipboard(text_to_copy):
    ...
    try:
        ...
        last_clipboard_content = text_to_copy
...
class ClipboardWindow(Gtk.Window):
    def __init__(self):
        ...
        print("Attempting to apply CSS styles to screen...")
        css_provider = Gtk.CssProvider()
        try:
            # Use updated CSS_DATA with hex codes
            css_provider.load_from_data(CSS_DATA)
            Gtk.StyleContext.add_provider_for_screen(
                Gdk.Screen.get_default(), css_provider,
                Gtk.STYLE_PROVIDER_PRIORITY_APPLICATION
            )
            print("CSS styles applied successfully to screen.")
    ...
    def on_map_event(self, widget, event):
        print("Window mapped, attempting focus grab.")
        self.present()
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Connecting to clipboard owner-change signal...")
        CLIPBOARD.connect("owner-change", on_clipboard_owner_change)
        print("Clipboard signal connected.")
        print("Requesting initial clipboard text asynchronously...")
        ...
        release_lock()
    print(f"Clipboard manager (PID: {os.getpid()}) exiting cleanly.")